...
def add_dataset_options(parser):
    ...
    # PointCLIP specific options
    group.add_argument("--grid_size", default=16, type=int, help="CoTracker3 grid size for PointCLIP (grid_size^2 = number of points)")
    group.add_argument("--data_path", default="/mnt/titan/mevis", help="Path to MeViS dataset for PointCLIP")
    group.add_argument("--extraction_method", default="cotracker3", help="Method used for point extraction (for checkpoint naming)")
    group.add_argument("--debug_subset_size", default=-1, type=int, help="Use only N videos for debugging/proof-of-concept (-1 = use all)")
